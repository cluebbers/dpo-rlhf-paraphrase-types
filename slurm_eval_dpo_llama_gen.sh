...
# sbatch slurm_eval_dpo_llama_gen.sh meta-llama/Llama-3.1-8B out/gen-models/llama-3.1-8b-etpc out/gen-models/dpo_meta-llama-Llama-3.1-8b_sigmoid out/gen-models/dpo_meta-llama-Llama-3.1-8b_ipo
