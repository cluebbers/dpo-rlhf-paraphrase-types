...
def parse_arguments():
    ...
    parser.add_argument(
        "--beta", type=float, default=0.1, help="Beta parameter for DPOTrainer"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--adapter_dir", type=str, default=None, help="Directory of the PEFT adapter"
    )
...
def main(
    ...
    save_context = (
        ...
        if not TRL_USE_RICH
            ...
            f"[bold green]Training completed! Saving the model to {output_dir}"
        )
    )
